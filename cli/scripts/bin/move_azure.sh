...
# Usage:
# ./move_git.sh source_branch="source_branch_name" target_branch="target_branch_name" file="path/to/your/file"
source common.sh
export AZURE_DEVOPS_PAT="amF5ZXNocGF0ZWxAVVRwbGF0Zm9ybW91dGxvb2sub25taWNyb3NvZnQuY29NOjd3b2hpeXV0eDY2d3Q2cnR1NDY3Yml2YW9zeWd3ZXp2ZDU3b2lweGpveXNoNnlocnRtemE="
export ORGANIZATION="UnitedTechnoICS"
export PROJECT="Boomi%20DevOps"
export REPOSITORY="6ce12766-f73e-4c0e-926d-576673b5a2e8"
...
# Fetch the latest commit SHA of the target branch
LATEST_COMMIT_SHA=$(curl -s -H "Authorization: Basic $B64_PAT" \
  "$AZURE_DEVOPS_URL/repositories/$REPOSITORY/commits?api-version=7.2-preview.1" | \
